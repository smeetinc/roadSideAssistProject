...
<div class="logoutmsg">
 <h1>See you soon!</h1>
                    ...
                    <form action="includes/login.inc.php" method="POST" class="logout">
                   <h3>Admin Login</h3>
                   
                   <input type="text" name="uid" placeholder="Username/e-mail" required="Enter an email address or username">
                   <br>
                   <br>
                   
                   <input type="password" name="pwd" placeholder="Password" required="Enter a Password">
                   <br>
                   <button type="submit" name="login">Login Again</button>
